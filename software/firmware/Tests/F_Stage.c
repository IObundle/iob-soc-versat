...
void SingleTest(Arena* arena){
   ...
   Assert_Eq(0x568f3f84,ACCEL_TOP_output_0_currentValue);
   Assert_Eq(0x6a09e667,ACCEL_TOP_output_1_currentValue);
   Assert_Eq(0xbb67ae85,ACCEL_TOP_output_2_currentValue);
   Assert_Eq(0x3c6ef372,ACCEL_TOP_output_3_currentValue);
   Assert_Eq(0xf34e99d9,ACCEL_TOP_output_4_currentValue);
   Assert_Eq(0x510e527f,ACCEL_TOP_output_5_currentValue);
   Assert_Eq(0x9b05688c,ACCEL_TOP_output_6_currentValue);
   Assert_Eq(0x1f83d9ab,ACCEL_TOP_output_7_currentValue);
