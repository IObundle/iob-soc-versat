...
void Versat_init_AES() {
   AESWithIterative_SimpleAddr addr = ACCELERATOR_TOP_ADDR_INIT;

   FillRoundPairAndKey(addr.simple.mk0.roundAndKey);
   ...
   ACCEL_TOP_simple_rcon7_constant = 0x80;
   ACCEL_TOP_simple_rcon8_constant = 0x1b;
   ACCEL_TOP_simple_rcon9_constant = 0x36;
...
void SingleTest(Arena* arena){
   ...
   uint8_t cypher[] = {0x32,0x88,0x31,0xe0,0x43,0x5a,0x31,0x37,0xf6,0x30,0x98,0x07,0xa8,0x8d,0xa2,0x34};
   ...
   uint8_t expected[] = {0x39,0x02,0xdc,0x19,0x25,0xdc,0x11,0x6a,0x84,0x09,0x85,0x0b,0x1d,0xfb,0x97,0x32};
