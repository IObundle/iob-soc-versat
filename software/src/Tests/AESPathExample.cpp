...
void SingleTest(Arena* arena){
  int inputs[] = {0x19,0xa0,0x9a,0xe9, // Start of round 1
                  0x3d,0xf4,0xc6,0xf8,
                  0xe3,0xe2,0x8d,0x48,
                  0xbe,0x2b,0x2a,0x08,
                  0x2b,0x28,0xab,0x09, // Cipher start
                  0x7e,0xae,0xf7,0xcf,
                  0x15,0xd2,0x15,0x4f,
                  0x16,0xa6,0x88,0x3c,
                  0x01,0x02,0x04,0x08, // Rcon start
                  0x10,0x20,0x40,0x80,
                  0x1b,0x36};

  AESPathExample_SimpleAddr addr = ACCELERATOR_TOP_ADDR_INIT;
  FillRoundPairAndKey(addr.simple.roundAndKey);
  ...
  int expectedOutput[] = {0xeb,0x59,0x8b,0x1b,
                          0x40,0x2e,0xa1,0xc3,
                          0xf2,0x38,0x13,0x42,
                          0x1e,0x84,0xe7,0xd2};

  for(int i = 0; i < ARRAY_SIZE(expectedOutput); i++){
    Assert_Eq(expectedOutput[i],SimpleOutputStart[i]);
  }
}
