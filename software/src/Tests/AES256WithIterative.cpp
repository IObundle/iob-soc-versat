...
void Versat_init_AES() {
   ...
   FillRoundPairAndKey(addr.simple.path.roundPairAndKey);
   FillMainRound(addr.simple.round0);
   FillKeySchedule(addr.simple.key6);
   FillSBox(addr.simple.subBytes);

   ACCEL_TOP_simple_rcon_0_constant = 0x01;
   ACCEL_TOP_simple_rcon_1_constant = 0x02;
   ACCEL_TOP_simple_rcon_2_constant = 0x04;
   ACCEL_TOP_simple_rcon_3_constant = 0x08;
   ACCEL_TOP_simple_rcon_4_constant = 0x10;
   ACCEL_TOP_simple_rcon_5_constant = 0x20;
   ACCEL_TOP_simple_rcon_6_constant = 0x40;
}
