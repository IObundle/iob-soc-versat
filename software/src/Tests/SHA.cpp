...
static size_t versat_crypto_hashblocks_sha256(const uint8_t *in, size_t inlen) {
   while (inlen >= 64) {
      ...
      if(!initVersat){
         VersatUnitWrite((versat_base + memMappedStart + 0x4000),0,initialStateValues[0]);
         VersatUnitWrite((versat_base + memMappedStart + 0x4001),0,initialStateValues[1]);
         VersatUnitWrite((versat_base + memMappedStart + 0x4002),0,initialStateValues[2]);
         VersatUnitWrite((versat_base + memMappedStart + 0x4003),0,initialStateValues[3]);
         VersatUnitWrite((versat_base + memMappedStart + 0x4004),0,initialStateValues[4]);
         VersatUnitWrite((versat_base + memMappedStart + 0x4005),0,initialStateValues[5]);
         VersatUnitWrite((versat_base + memMappedStart + 0x4006),0,initialStateValues[6]);
         VersatUnitWrite((versat_base + memMappedStart + 0x4007),0,initialStateValues[7]);
         initVersat = true;
      }
...
void VersatSHA(uint8_t *out, const uint8_t *in, size_t inlen) {
   ...
   store_bigendian_32(&out[0*4],(uint32_t) VersatUnitRead((versat_base + memMappedStart + 0x4000),0));
   store_bigendian_32(&out[1*4],(uint32_t) VersatUnitRead((versat_base + memMappedStart + 0x4001),0));
   store_bigendian_32(&out[2*4],(uint32_t) VersatUnitRead((versat_base + memMappedStart + 0x4002),0));
   store_bigendian_32(&out[3*4],(uint32_t) VersatUnitRead((versat_base + memMappedStart + 0x4003),0));
   store_bigendian_32(&out[4*4],(uint32_t) VersatUnitRead((versat_base + memMappedStart + 0x4004),0));
   store_bigendian_32(&out[5*4],(uint32_t) VersatUnitRead((versat_base + memMappedStart + 0x4005),0));
   store_bigendian_32(&out[6*4],(uint32_t) VersatUnitRead((versat_base + memMappedStart + 0x4006),0));
   store_bigendian_32(&out[7*4],(uint32_t) VersatUnitRead((versat_base + memMappedStart + 0x4007),0));
